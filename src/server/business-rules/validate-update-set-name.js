(function executeRule(current, previous /*null when async*/) {
    ...
    if (!pattern.test(name)) {
        gs.addErrorMessage(
            'Invalid Update Set name. Expected: x_<scope>_<app>_(feat|fix|chore|refactor|hotfix)_<TICKET-123>_<description>_YYYYMMDD' +
            ' \u2014 e.g. x_1892699_purple_pack_feat_SN-4821_my_feature_20260715'
        );
