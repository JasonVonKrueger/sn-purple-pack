...
Record({
    ...
    data: {
        ...
        add_message: false,
        advanced: true,
        description: 'Enforces the Purple Pack update set naming convention: x_<scope>_<app>_(feat|fix|chore|refactor|hotfix)_<TICKET-123>_<description>_YYYYMMDD',
        order: 100,
