...
Flow(
    {
        ...
        name: "Purple Pack",
        description: "Main Purple Pack orchestration flow. Triggers when a service account is created and provisions the full integration (OAuth app).",
        runAs: "system",
        flowPriority: "MEDIUM",
    },
    wfa.trigger(
    ...
    (_params) => {
        ...
        wfa.flowLogic.else({ $id: Now.ID["integration_failed"] }, () => {
            wfa.action(
                action.core.log,
